...
describe("PotentialHMODetailPanel — nothing is asserted without a value", () => {
  it("does not pass or fail a property on compliance it never measured", () => {
    render(<PotentialHMODetailPanel property={base} defaultOpen isPremium />)
  ...
  it("never prints the string 'N/A%'", () => {
    const { container } = render(<PotentialHMODetailPanel property={base} defaultOpen isPremium />)
  ...
  it("still shows a real measurement when one is held", () => {
    ...
    render(<PotentialHMODetailPanel property={measured} defaultOpen isPremium />)
